...
set(_vtk_installed_prefix "C:/Users/mineo/Anaconda38/Library/lib/cmake/vtk-8.2")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "C:/Users/mineo/Anaconda38/Library")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "C:/Users/mineo/Anaconda38/Library/bin")
  else ()
    set (VTK_RUNTIME_DIRS "C:/Users/mineo/Anaconda38/Library/lib")
  endif ()
else()
  if (WIN32)
