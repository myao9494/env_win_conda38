#  tests for h5py-2.10.0-nompi_py38ha551744_104 (this is a generated file);
print('===== testing package: h5py-2.10.0-nompi_py38ha551744_104 =====');
...
print('===== h5py-2.10.0-nompi_py38ha551744_104 OK =====');
print("import: 'h5py'")
import h5py
